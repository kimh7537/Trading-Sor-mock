...
**Phase 1 완료 (20/20), Phase 2 진행 중 (10/14).** `core/`, `exchange/`(매칭 엔진), `sor/`(통합 호가창·최선집행 평가·집행 전략 4종), `bench/`. `ledger/`·`fep/`·`channel/`·`web/`은 아직 계획이다.

- 다음 태스크: `docs/TASKS.md`의 T2-11
