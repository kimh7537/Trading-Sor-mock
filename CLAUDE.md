...
**Phase 1 완료 (20/20), Phase 2 완료 (14/14).** Phase 2의 산출물인 전략 비교 표가 `bench/results/strategies-2026-09-16.md`에 있다. `core/`, `exchange/`(매칭 엔진), `sor/`(통합 호가창·최선집행 평가·집행 전략 4종), `bench/`. `ledger/`·`fep/`·`channel/`·`web/`은 아직 계획이다.

- 다음 태스크: `docs/TASKS.md`의 T3-01 (Phase 3 — 원장 + FEP)
