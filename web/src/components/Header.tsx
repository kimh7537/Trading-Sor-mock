...
function best(books: Partial<Record<Market, Book>>, ask: boolean) {
  let price = 0;
  let where: Market[] = [];
...
export function Header({
  ...
  const ask = best(books, true);
  const bid = best(books, false);
